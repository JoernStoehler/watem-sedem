...
> **WARNING: This document was generated by an AI agent and has NOT been reviewed or approved by Jörn. Do not treat any part of it as decided. It is a reference for reasoning about what might be needed, not an authoritative plan. Every decision (folder names, phase scope, architecture choices) requires Jörn's explicit approval.**
